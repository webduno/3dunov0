...
class OpenPetWorldIsland extends DOM_MANAGER.DOMManager {
  ...
  {
    console.log("https://webduno.com/opet/test/")
    ...
    //   }
      ...
      console.log("https://webduno.com/opet/test/ 111")
      ...
      console.log("https://webduno.com/opet/test/ 222")
  ...
  async _LoadBlockchainData()
  {
    ...
    try {
      ...
      notThePet.AddComponent(new gltf_component.AnimatedModelComponent({
          scene: this._scene,
          // resourcePath: 'https://webduno.com/opet/_resources/pets/fbx/',
          resourceName: `https://webduno.com/opet/_resources/pets/fbx/${foundPetName.toLowerCase()}`+'.fbx',
          scale: 3,
          visible: false,
          receiveShadow: true,
          castShadow: true,
  ...
  _LoadMobs()
  {
    ...
    for (let i = 0; i < this.MONSTER_COUNT; ++i) {
      ...
      npc.AddComponent(new npc_entity.NPCController({
          ...
          resourcePath: 'https://webduno.com/opet/_resources/items/resources/monsters/FBX/',
          npcId:i,
          deathCallback: (e) => {
            this.deathCounter++
            this.searchLife(e)
  ...
  _LoadGoals()
  {
    ...
    platform.AddComponent(new gltf_component.StaticModelComponent({
        scene: this._scene,
        // resourcePath: 'https://webduno.com/opet/_resources/fbx/islands/',
        resourceName: 'https://webduno.com/opet/_resources/fbx/islands/goals.sign.fbx',
        scale: 1,
        receiveShadow: true,
        castShadow: true,
    }));
    ...
    helppButton.AddComponent(new gltf_component.AnimatedModelComponent({
        scene: this._scene,
        // resourcePath: 'https://webduno.com/opet/_resources/fbx/islands/',
        resourceName: 'https://webduno.com/opet/_resources/fbx/islands/goals.search.fbx',
        scale: 1,
        // visible: false,
        receiveShadow: true,
        castShadow: true,
