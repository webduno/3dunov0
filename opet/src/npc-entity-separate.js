...
export const npc_entity = (() => {
  ...
  class NPCController extends entity.Component {
    ...
    _Init(params) {
      this.deathCallback = params.deathCallback
    ...
    _LoadModels() {
      ...
      loader.load(this._params.resourceName, (glb) => {
        ...
        this._manager.onLoad = () => {
          // alert("_manager loaded")
          console.log("_manager loaded")
        ...
        loader.load('Getting Hit Backwards.fbx', (a) => { this._animations['death'] = _FindAnim(a, "Getting Hit Backwards.fbx") });
        loader.load('Mma Kick.fbx', (a) => { this._animations['attack'] = _FindAnim(a, "Mma Kick.fbx") });


        // this._animations['idle'] = null
        // this._animations['walk'] = null
        // this._animations['death'] = null
        // this._animations['attack'] = null
    ...
    _OnAIWalk(timeInSeconds) {
      ...
      // if (pos.x < -20 || pos.x > 20 || pos.z < -20 || pos.z > 76)
      {
        pos.add(forward);
      }
      // pos.add(sideways);
