...
export const player_entity = (() => {
  ...
  class BasicCharacterController extends entity.Component {
    ...
    _Init(params) {
      ...
      this._sideAcceleration = new THREE.Vector3(1, 0.125, 65.0);
    ...
    _LoadCustomModels() {
      ...
      loader.load('aj.fbx', (fbx) => {
        ...
        loader.load('Standard Idle.fbx', (a) => { _OnLoad('death', a); });
      });
    }
    _LoadMinecraftModels() {
      ...
      loader.load('stebb2.fbx', (fbx) => {
        ...
        loader.load('Walking.fbx', (a) => { _OnLoad('walk', a); });
        loader.load('Mma Kick.fbx', (a) => { _OnLoad('attack', a); });
        loader.load('Running.fbx', (a) => { _OnLoad('run', a); });
    ...
    Update(timeInSeconds) {
      ...
      if (input._keys.left) {
        _A.set(0, 1, 0);
        _Q.setFromAxisAngle(_A, 4.0 * Math.PI * timeInSeconds * this._sideAcceleration.y);
        _R.multiply(_Q);
      }
      ...
      if (pos.x < -10 || pos.x > 190 || pos.z < -100 || pos.z > 100) {
        return
      }
