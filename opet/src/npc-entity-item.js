...
export const npc_entity = (() => {
  ...
  class NPCController extends entity.Component {
    ...
    _Init(params) {
      ...
      this._acceleration = new THREE.Vector3(1, 0.25, 2.0);
      ...
      loader.load(this._params.resourceName, (glb) => {
        ...
        this._target.traverse(c => {
          ...
          if (c.material) {
            ...
            // c.material = new THREE.MeshStandardMaterial({color: 0xFCE874, metalness: 0.35, roughness: 0.5})
        ...
        this._animations['walk'] = _FindAnim('Idle');
        this._animations['death'] = _FindAnim('Dead');
        this._animations['attack'] = _FindAnim('Flipped');
