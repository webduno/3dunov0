  ...
  class NPCController extends entity.Component {
    ...
    _LoadModels() {
      ...
      loader.load(this._params.resourceName, (glb) => {
        ...
        this._animations['idle'] = _FindAnim('Standing W_Briefcase Idle');
        this._animations['walk'] = _FindAnim('Walking');
        this._animations['death'] = _FindAnim('Getting Hit Backwards');
        this._animations['attack'] = _FindAnim('Mma Kick');
