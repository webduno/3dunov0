...
export const gltf_component = (() => {
  ...
  class StaticModelComponent extends entity.Component {
    ...
    _LoadModels() {
      console.log("this._params.resourceName", this._params.resourceName)
    ...
    _OnLoaded(obj) {
      obj.children.length == 1 && console.log(obj.children[0].name)
      if (obj.children.length == 1 && obj.children[0].name == "pet_roulette_top")
      {
        document.getElementById('loading-container').style.display = "none"
        document.getElementById('container').style.visibility = "visible"
      }
      // obj.children.length > 30 && console.log(obj.children[0].name) && console.log(obj.children[0].name == "Snake_0") && console.log(window.loadedObjs)
      this._target = obj;
